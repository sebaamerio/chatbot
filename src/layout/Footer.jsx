		...
		<footer>
			<div className="footer__container">
				<figure className="footer__figure">
					<img className="footer__image" src={ImageBsAsFooter} alt="Buenos Aires Provincia"></img>
				</figure>
					...
					<aside className="aside">
						...
						<nav className="aside__nav">
							<div className="aside__menu">
								...
								<span className="aside__text">Whatsapp: +54 9 221 593-5031</span>
							</div>
							<div className="aside__menu">
								<img src={iconReloj} alt="Reloj" />
								<span className="aside__text">Lunes a Viernes de 09 a 15 hs</span>
							</div>
						...
						<nav className="aside__nav">
							<div className="aside__social">
								...
								<a href="https://www.instagram.com/provinciaba" target="_blank">
									<img alt="instagram Buenos Aires Provincia" src={social_instagram} />
								</a>
								<a href="https://www.youtube.com/channel/UCRuY8kHZHaiqAAdjcgobsNw" target="_blank">
									<img alt="youtube Buenos Aires Provincia" src={social_yotube} />
								</a>
							</div>
						</nav>
